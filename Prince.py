...
def ua():
    ...
    xx=f"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/74.0.3729.169 Safari/537.3"
    return xx
#----------------------------[LOGO]-----------------------------------#
logo = (f"""        
   \033[0;32m   
...
[\033[1;92m\033[1;34m✔\033[1;92m]TOOL           \033[1;91m\033[1;34m: \033[1;92mTEST-OLD ID
