...
def ua():
    ...
    xx=f"Mozilla/5.0 (iPhone; CPU iPhone OS 12_2 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/12.1 Mobile/15E148 Safari/604.1"
    return xx
#----------------------------[LOGO]-----------------------------------#
logo = (f"""        
   \033[0;32m   
...
[\033[1;92m\033[1;34m✔\033[1;92m]TOOL           \033[1;91m\033[1;34m: \033[1;92mNO4-OLD ID
